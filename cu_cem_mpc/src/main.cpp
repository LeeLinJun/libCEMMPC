...
int main(){
    ...
    int NP = 5, NS = 32, NE = 4, NT = 4, max_it = 5;
   ...
   double goal[4*5] = { -21.87288909,  -4.25320562,  -2.92477117,  -1.03945387,
                         ...
                         -21.87288909,  -4.25320562,  -2.92477117,  -1.03945387, 
                         -21.87288909,  -4.25320562,  -2.92477117,  -1.03945387};
    //int NP = 2, NS = 128, NE = 4, NT = 4, max_it = 2;
    //double start[4] = {-21.55734286,  -1.6512908 ,  -2.85039622,  -0.36047371};
    //double goal[4] = {-21.87288909,  -4.25320562,  -2.92477117,  -1.03945387};
    /*double start[4 * 2] = { -21.55734286,  -1.6512908 ,  -2.85039622,  -0.36047371,
                         -21.55734286,  -1.6512908 ,  -2.85039622,  -0.36047371,
                          };
    double goal[4 * 2] = { -21.87288909,  -4.25320562,  -2.92477117,  -1.03945387,
                         -21.87288909,  -4.25320562,  -2.92477117,  -1.03945387,
                          };*/
    ...
    std::vector<std::vector<double>> _obs_list(
        {{-11.76184125,  -2.75},   
         ...
         {15.30796802,  -2.75},      
         { 0.64608927,   3.75}});
    cartpole_parallel::CartpoleParallel model(NP, NS, NE, NT, max_it, _obs_list, 4);
